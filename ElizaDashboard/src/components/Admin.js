                ...
                <div className="sales-and-notifications">
                    ...
                    <div className="notifications">
                        ...
                        <ul>
                            {[
                                {
                                    title: "New Patent filed: Patent A",
                                    details:
                                        "Patent A has been officially filed and is now awaiting approval. The filing number is 123456789. Expected response time: 30 days.",
                                },
                                {
                                    title: "Trademark registered for XYZ",
                                    details:
                                        "The trademark for XYZ has been successfully registered and is now protected. The registration number is 987654321. This registration is valid for 10 years.",
                                },
                                {
                                    title: "Scheduled maintenance on 07 July, 2024",
                                    details:
                                        "Scheduled maintenance on the system will occur on 07 July, 2024, from 2:00 AM to 5:00 AM. During this time, the system will be temporarily unavailable.",
                                },
                                {
                                    title: "New Trademark application filed",
                                    details:
                                        "A new trademark application has been filed for 'Tech Innovators'. This application is currently under review. Review period: 20 days.",
                                },
                                {
                                    title: "Patent Renewal Due for Patent B",
                                    details:
                                        "Patent B is due for renewal on 15 August, 2024. Please ensure the renewal fee is paid before the due date to avoid expiration. Renewal fee: $500.",
                                },
                                {
                                    title: "IPR Compliance Training Scheduled",
                                    details:
                                        "A mandatory IPR compliance training session has been scheduled for all staff on 10 July, 2024, from 9:00 AM to 11:00 AM. Location: Conference Room A.",
                                },
                        ...
                        <li key={index} className="startup-item">
                            ...
                            >
                                ...
                                <p className="patent-count">
                                    {startup.patents.length} Patent
                                    {startup.patents.length > 1 ? "s" : ""}
                                </p>
                            </div>
                        ...
                        <li key={index} className="researcher-item">
                            ...
                            >
                                ...
                                <p className="research-count">
                                    {researcher.researches.length} Research
                                    {researcher.researches.length > 1
                                        ? "es"
                                        : ""}
                                </p>
                                <p className="patent-count">
                                    {researcher.patents.length} Patent
                                    {researcher.patents.length > 1 ? "s" : ""}
                                </p>
                            </div>
        ...
        <div className="dashboard-container">
            ...
            <div className="sidebar">
                <div className="sidebar-menu">
                    ...
                    <button onClick={() => setActiveSection("startups")}>
                        Startups
                    </button>
                    <button onClick={() => setActiveSection("researchers")}>
                        Researchers
                    </button>
                    <button onClick={() => setActiveSection("investors")}>
                        Investors
                    </button>
                    <button onClick={() => setActiveSection("iprManagement")}>
                        IPR Management
                    </button>
...
const StartupDetails = ({ startups }) => {
    ...
    return (
        <div className="startup-details">
            <h2>{startup.name}</h2>
            <p>
                <strong>Patents:</strong> {startup.patents.join(", ") || "None"}
            </p>
            <Link to="/">
